...
\            'link:css': [{'rel': 'stylesheet'}, {'href': '|style.css'}, {'media': 'all'}],
\            'link:print': [{'rel': 'stylesheet'}, {'href': '|print.css'}, {'media': 'print'}],
...
\            'form': {'action': ''},
\            'form:g': {'name': '', 'action': '', 'method': 'GET'},
\            'form:p': {'name': '', 'action': '', 'method': 'POST'},
